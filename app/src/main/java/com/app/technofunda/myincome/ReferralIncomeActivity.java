...
public class ReferralIncomeActivity extends AppCompatActivity {

    public double d=0,h=0,n=0,a=0,b,g,f,m;
    TextView totamnt,tottds,totadmin,totnetpay;
    ListView refllist;
    String duid1,dmbbno,refincome,rupee,jsonStr;
    private ProgressDialog pDialog;
    private static String url;
    private static final String TAG_CONTACTS = "Direct Reffral";
    ...
    ArrayList<HashMap<String, String>> addplanshowinlist;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.referralincome_activity);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        totamnt=(TextView)findViewById(R.id.txt_rinc);
        tottds=(TextView)findViewById(R.id.txt_rtds);
        totadmin=(TextView)findViewById(R.id.txt_radm);
        totnetpay=(TextView)findViewById(R.id.txt_rnet);

        refllist = (ListView)findViewById(R.id.refrin_listview);
        addplanshowinlist = new ArrayList<HashMap<String, String>>();
        ...
        if (nf != null && nf.isConnected() == true) {
            refincome = "refralincome";
            url = Config.URL+"/api/Apiurl.aspx?Mobile=" + String.valueOf(dmbbno) + "&msg=" + String.valueOf(refincome) + "%20" + String.valueOf(duid1);
        ...
        homef.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ReferralIncomeActivity.this,frontview.class);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent=new Intent(ReferralIncomeActivity.this,NewsUpdateActivity.class);
//                startActivity(intent);
//
//            }
//        });
        ...
        logoutf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NetworkInfo nf = cn.getActiveNetworkInfo();
                if (nf != null && nf.isConnected() == true) {
                    progressBar = ProgressDialog.show(ReferralIncomeActivity.this, "Please wait ...", "Logout processing ...", false);
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            session.logoutUser();
                            progressBar.dismiss();
                            ReferralIncomeActivity.this.finish();
                        }
                    }).start();
        ...
        profilef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ReferralIncomeActivity.this,ProfileActivity.class);
                startActivity(intent);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ReferralIncomeActivity.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        contact.put(TAG_DIRECT,c.getString(TAG_DIRECT));
        ...
        protected void onPostExecute(Void result) {
            ...
            if(addplanshowinlist.size()!=0) {
                ListAdapter adapter = new SimpleAdapter(ReferralIncomeActivity.this, addplanshowinlist,
                        R.layout.referral_income_list_row, new String[]{TAG_LOGID, TAG_DIRECT, TAG_AMOUNT, TAG_INCOME, TAG_TDS,TAG_ADMIN,TAG_NETPAY}, new int[]
                        {R.id.txt_rlogid, R.id.txt_rdirect, R.id.txt_ramt, R.id.txt_rincome, R.id.txt_rtds,R.id.txt_radmin,R.id.txt_rnetpay});
                refllist.setAdapter(adapter);
    ...
    private void alertPkgEmpty(){
        ...
        builder1.setTitle("Referral Income");
