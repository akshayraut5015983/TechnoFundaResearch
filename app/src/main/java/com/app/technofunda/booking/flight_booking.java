...
public class flight_booking extends FragmentActivity {
     ...
     /*   back=(ImageView)findViewById(R.id.backarrow);
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(flight_booking.this,frontview.class);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent=new Intent(flight_booking.this,NewsUpdateActivity.class);
//                startActivity(intent);
//
//            }
//        });
        ...
        logoutf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nf != null && nf.isConnected() == true) {
                    progressBar = ProgressDialog.show(flight_booking.this, "Please wait ...", "Logout processing ...", false);
        ...
        profilef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(flight_booking.this,ProfileActivity.class);
                startActivity(intent);
       ...
       /* String urls = Config.URL + "/api/apilogin.aspx?uid=" + String.valueOf(loginid) + "&pass=" + String.valueOf(passwords) + "&mbl=" + String.valueOf(mobilenumber);
        flight_booking.DownloadWebPageTask task2 = new flight_booking.DownloadWebPageTask();
    ...
    private class DownloadWebPageTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (s.contains("Login Failed")) {
                AlertDialog.Builder builder2 = new AlertDialog.Builder(flight_booking.this);
