...
public class TradingMainAdapter extends RecyclerView.Adapter<TradingMainAdapter.ViewHolder> {
    ...
    public TradingMainAdapter(List<TradingMainResponce> superHeroes, Context context) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_treding_main, parent, false);
