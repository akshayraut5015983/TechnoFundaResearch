...
public class FuturesAdapter extends RecyclerView.Adapter<FuturesAdapter.ViewHolder> {
    ...
    public FuturesAdapter(List<TradingMainResponce> superHeroes, Context context) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_derivatives, parent, false);
