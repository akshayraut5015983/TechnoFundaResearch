...
public class FoodGrains extends AppCompatActivity {
    ...
    public static final String TAG_Disc = "discount";
    public static final String TAG_SellPrice = "sellingprice";
...
//        offer_tag=(TextView)findViewById(R.id.offer);
        ...
        imgcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(FoodGrains.this,ShowCart.class);
        ...
        homef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FoodGrains.this, frontview.class);
                startActivity(intent);
            }
        });
        ...
        updatef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FoodGrains.this, NewsUpdateActivity.class);
                startActivity(intent);
        ...
        logoutf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nf != null && nf.isConnected() == true) {
                    progressBar = ProgressDialog.show(FoodGrains.this, "Please wait ...", "Logout processing ...", false);
        ...
        profilef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FoodGrains.this, ProfileActivity.class);
                startActivity(intent);
...
//Showing a progress dialog
        loading = ProgressDialog.show(FoodGrains.this,"Loading Data", "Please Wait...",false,false);
//Creating a json array request
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(MY_URL + String.valueOf(mobilenumber) + "&msg=" + String.valueOf(msg) + "%20" + String.valueOf(category), new Response.Listener<JSONArray>() {
            ...
            //    Toast.makeText(FoodGrains.this, "response:" + response, Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FoodGrains.this);
    ...
    private void parseData(JSONArray array){
        for(int i = 0; i<array.length(); i++) {
            ...
            try {
                ...
                superHero.setDisc(json.getString(TAG_Disc));
                superHero.setSellPrice(json.getString(TAG_SellPrice));
        ...
        adapter = new CardAdapterCategoryList1(listSuperHeroes,FoodGrains.this);
