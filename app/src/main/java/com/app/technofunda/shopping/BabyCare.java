...
//        offer_tag=(TextView)findViewById(R.id.offer);
        ...
        imgcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(BabyCare.this,ShowCart.class);
        ...
        homef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BabyCare.this, frontview.class);
                startActivity(intent);
            }
        });
        ...
        updatef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BabyCare.this, NewsUpdateActivity.class);
                startActivity(intent);
        ...
        logoutf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nf != null && nf.isConnected() == true) {
                    progressBar = ProgressDialog.show(BabyCare.this, "Please wait ...", "Logout processing ...", false);
        ...
        profilef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BabyCare.this, ProfileActivity.class);
                startActivity(intent);
...
//Showing a progress dialog
        loading = ProgressDialog.show(BabyCare.this,"Loading Data", "Please Wait...",false,false);
//Creating a json array request
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BabyCare.this);
    ...
    private void parseData(JSONArray array){
        ...
        adapter = new CardAdapterCategoryList1(listSuperHeroes,BabyCare.this);
