...
public class BeautyAndHygine extends AppCompatActivity {
...
//        offer_tag=(TextView)findViewById(R.id.offer);
        ...
        imgcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(BeautyAndHygine.this,ShowCart.class);
        ...
        homef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BeautyAndHygine.this, frontview.class);
                startActivity(intent);
            }
        });
        ...
        updatef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BeautyAndHygine.this, NewsUpdateActivity.class);
                startActivity(intent);
        ...
        logoutf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nf != null && nf.isConnected() == true) {
                    progressBar = ProgressDialog.show(BeautyAndHygine.this, "Please wait ...", "Logout processing ...", false);
        ...
        profilef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BeautyAndHygine.this, ProfileActivity.class);
                startActivity(intent);
...
//Showing a progress dialog
        loading = ProgressDialog.show(BeautyAndHygine.this,"Loading Data", "Please Wait...",false,false);
//Creating a json array request
        category = "beautyandhygine";
        msg = "Product";
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(MY_URL + String.valueOf(mobilenumber) + "&msg=" + String.valueOf(msg) + "%20" + String.valueOf(category), new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                //    Toast.makeText(BabyCare.this, "response:" + response, Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BeautyAndHygine.this);
    ...
    private void parseData(JSONArray array){
        ...
        adapter = new CardAdapterCategoryList1(listSuperHeroes,BeautyAndHygine.this);
