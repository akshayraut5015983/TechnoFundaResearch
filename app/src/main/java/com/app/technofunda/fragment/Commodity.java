...
public class Commodity extends Fragment {
    ...
    private List<EquityResponce> listSuperHeroesall;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.tab_three_frag, container, false);
        ...
        listSuperHeroesall = new ArrayList<>();
    ...
    private void parseDataforBuy(JSONArray array) {
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                if (String.valueOf(json.get("segment")).equals("Commodity")) {
