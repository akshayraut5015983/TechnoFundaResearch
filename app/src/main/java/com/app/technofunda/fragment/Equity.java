...
import com.app.technofunda.adapter.EquityAdapter;
...
public class Equity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.tab_one_frag, container, false);

       /* Bundle bundle = getActivity().getIntent().getExtras();
        ArrayList<? extends TradingMainResponce> arraylist = bundle.getParcelableArrayList("list");
        for (int i = 0; i < arraylist.size(); i++) {
            Log.d("item", String.valueOf(arraylist.get(i)));
        ...
        adapter = new EquityAdapter(listSuperHeroes, getActivity().getApplicationContext());
    ...
    private void parseDataforBuy(JSONArray array) {
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                if (String.valueOf(json.get("segment")).equals("Equity")) {
